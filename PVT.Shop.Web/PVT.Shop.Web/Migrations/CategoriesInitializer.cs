        ...
        public static void Initialize(ShopContext context)
        {
            if (!context.Categories.Any())
            {
                var root = new Category()
                           {
                               Name = "Catalog",
                               Description = "Product Directory contains a list of all products. In each section, the product catalog is a description of a particular product, including its ID, name, category, information on the availability and other product attributes.",

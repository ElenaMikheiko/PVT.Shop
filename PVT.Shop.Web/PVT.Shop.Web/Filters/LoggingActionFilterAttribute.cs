namespace PVT.Shop.Web.Filters
{
    ...
    public class LoggingActionFilterAttribute : FilterAttribute, IActionFilter
    {
        private static string _partOfPath = DateTime.Now.ToShortDateString().Replace("/", "_").Replace(".", "_") + "-log.txt";

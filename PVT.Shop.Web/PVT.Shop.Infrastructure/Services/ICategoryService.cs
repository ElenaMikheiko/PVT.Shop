namespace PVT.Shop.Infrastructure.Services
{
    ...
    public interface ICategoryService
    {
        ...
        CategoryProductsViewModel GetCategoryProducts(string q, int categoryId, int page = 1, int pageSize = 6);

        CategoryProductsViewModel SearchCategoryProducts(string name, int categoryId = 1, int page = 1, int pageSize = 30);
        ...
        CategoryForEditViewModel GetCategoryForEdit(int categoryId, int parentId = 1);
